...
public class VRFootIK : MonoBehaviour
{
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        if (hasHit)
        {
            ...
            //animator.SetIKRotation(AvatarIKGoal.RightFoot, rightFootRotWeight);
        ...
        if (hasHit)
        {
            animator.SetIKPositionWeight(AvatarIKGoal.RightFoot, leftFootPosWeight);
            ...
            //animator.SetIKRotation(AvatarIKGoal.LeftFoot, leftFootRotWeight);
